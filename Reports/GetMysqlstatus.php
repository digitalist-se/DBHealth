...
namespace Piwik\Plugins\DBHealth\Reports;
 ...
 */
class GetMysqlstatus extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('DBHealth_Mysqlstatus');
        $this->dimension     = null;
        $this->documentation = Piwik::translate('Show status of your database');
        ...
        // $this->subcategoryId = 'DBHealth_Mysqlstatus';
    }
    ...
    {
        $view = new View('@DBHealth/getMysqlstatus');
        $view->myData = array();
